...
resource "aws_lambda_function" "vrli_cloud_lambda-s3eventlogs" {
  filename      = "./Lambda.zip"
  function_name = "vrli_cloud_lambda-s3eventlogs"
...
resource "aws_lambda_permission" "vrli_cloud_lambda_permission" {
  ...
  function_name = aws_lambda_function.vrli_cloud_lambda-s3eventlogs.arn
...
resource "aws_s3_bucket_notification" "vrli_cloud_lambda_s3trigger" {
    ...
    lambda_function {
        lambda_function_arn = aws_lambda_function.vrli_cloud_lambda-s3eventlogs.arn
